For any real application, most persist state will need to use a separate `Effect`, like a database. In [Side Effects](/sideeffects) we demonstrated how to use a custom effect to wrap a database.
