...
export declare function listenChange(cb: (target: HyperView, action: string, value: string) => void): void;
export declare function listenInput(startedTyping: (target: HyperView) => void, cb: (target: HyperView, action: string, value: InputValue) => void): void;
